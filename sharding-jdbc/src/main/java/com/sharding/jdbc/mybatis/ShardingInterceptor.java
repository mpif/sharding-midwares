...
import com.sharding.jdbc.mybatis.annotation.NonSharding;
...
import com.sharding.jdbc.mybatis.datasource.DataSourceLocalKeys;
import com.sharding.jdbc.mybatis.support.*;
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if(targetObject instanceof Executor){
			...
			if(shardingMeta != null){
				...
				ShardingStrategy.NumberPair pair = shardingStrategy.sharding(shardingValue, shardingTableCount, shardingDBCount);
