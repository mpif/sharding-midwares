...
import com.sharding.redis.jedis.loadbalance.LoadBalance;
import com.sharding.redis.jedis.loadbalance.RandomLoadBalance;
...
public class ShardedJedisTemplate {
	...
	public ShardedJedisGroupPool getShardedJedisGroupPool() {
		return shardedJedisGroupPool;
	}
